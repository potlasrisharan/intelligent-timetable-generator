            ...
            <div className="mt-6 rounded-[1.4rem] border border-white/8 bg-white/4 p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-300">
                {user.role === "STUDENT"
                  ...
                  : "Deployable frontend for Vercel, FastAPI, Supabase, and OR-Tools."}
              </p>
            </div>
          </div>
                  ...
                  <Input
                    ...
                    placeholder={
                      user.role === "STUDENT"
                        ...
                        : "Search sections, faculty, room availability, or solver runs"
                    }
            ...
            <div className="glass-panel rounded-[1.35rem] px-5 py-4 text-sm text-slate-300">
              <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div className="flex items-center gap-2 text-slate-200">
                  ...
                  {user.role === "STUDENT"
                    ? "Your timetable is generated by OR-Tools CP-SAT scheduling engine."
                    : user.role === "TEACHER"
                    ? "Your schedule is optimised for compactness by the OR-Tools solver."
